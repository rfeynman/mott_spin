...
def compare_fast_slow(test_run_nums, average_fast_sherman, delta_average_fast_sherman, sherman_function, folder_path, 
    ...
    # Adjust space for legend - increased wspace from 0.35 to 0.45
    ...
    ax1.grid(True)
    # Place legend outside the plot and add a white box with black edge
    ...
    ax2.grid(True)
    ax2.legend(facecolor='white', edgecolor='black')
